package snippets.linkedin.api.a1;
...
public class Demo {
    public static void main(String[] args) {
        ...
        try {
            ...
            //URL url = new URL("http://api.linkedin.com/v1/people/~:(id,first-name,last-name,picture-url,headline,educations)");
            //URL url = new URL("http://api.linkedin.com/v1/people/~/connections");
            //URL url = new URL("http://api.linkedin.com/v1/company-search?keywords=liberty");
            URL url = new URL("http://api.linkedin.com/v1/people-search?keywords=liberty+international");
