 ...
 * 
 */
@WebServiceClient(name = "Service1", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://localhost:8181/Service1.asmx?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8181/Service1.asmx?wsdl");
    ...
    public Service1Soap getService1Soap(WebServiceFeature... features) {
        return super.getPort(new QName("http://tempuri.org/", "Service1Soap"), Service1Soap.class, features);
    }
