...
public interface CurrencyConvertorSoap {
    ...
    @RequestWrapper(localName = "ConversionRate", targetNamespace = "http://www.webserviceX.NET/", className = "snippets.jee.jaxws.maven.plugin.a1.stub.ConversionRate")
    @ResponseWrapper(localName = "ConversionRateResponse", targetNamespace = "http://www.webserviceX.NET/", className = "snippets.jee.jaxws.maven.plugin.a1.stub.ConversionRateResponse")
